...
(defroutes casper-routes
  ...
  (GET "/" [] (send-response http-status-ok "CLOJOKU - Sudoku written in Clojure.  Enter a string of 81 characters ranging 0 - 9 for a sudoku board.  A zero is an empty slot.  Usage: /game/{string of 81 characters of 0-9}. Example /game/123050000450789023709003006204005097360000214090010300001002970000900530900501040"))
